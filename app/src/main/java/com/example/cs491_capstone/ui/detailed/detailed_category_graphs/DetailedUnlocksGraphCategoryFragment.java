...
public class DetailedUnlocksGraphCategoryFragment extends Fragment implements View.OnClickListener {
    ...
    private void generateColumnDataTopAsUnlocks() {
        ...
        for (int i = 0; i < numColumns; i++) {
            ...
            for (int j = 0; j < numSubcolumns; j++) {
                //
                int val = Integer.parseInt(App.localDatabase.getSumTotalStatByCategory(App.currentPeriod.get(0).get(i), DatabaseHelper.UNLOCKS_COUNT, categoryName));
    ...
    private void generateColumnDataBottomAsUnlocks(int columnIndex, int color) {
        ...
        for (int i = 0; i < barDataBottom.getColumns().size(); i++) {
            ...
            for (int j = 0; j < column.getValues().size(); j++) {
                ...
                int value = Integer.parseInt(App.localDatabase.getSumTotalStatByCategory(App.currentPeriod.get(0).get(columnIndex), String.valueOf(i), DatabaseHelper.UNLOCKS_COUNT, categoryName));
