...
public class ShowAllRelatedGoals extends AppCompatActivity {

    RecyclerView goalsRecycler;
    GoalImageAdapter goalAdapter;
    List<Goal> goalsList;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Goal goal = intent.getParcelableExtra("GOAL_TYPE");
        if (goal.getType().equals(GoalDataBaseHelper.GOAL_PHONE)) {
            goalsList = App.goalDataBase.getMatchingPhoneGoals();
        } else {
            goalsList = App.goalDataBase.getMatchingAppGoals(goal.getPackageName());
        }
        ...
        goalsRecycler = findViewById(R.id.show_all_card);
        LinearLayoutManager layoutManagerWeek = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);

        goalsRecycler.setLayoutManager(layoutManagerWeek);
        goalsRecycler.setHasFixedSize(true);


        goalAdapter = new GoalImageAdapter(this, goalsList);
    ...
    public static class GoalImageAdapter extends RecyclerView.Adapter<GoalImageAdapter.ImageViewHolder> {
        ...
        public GoalImageAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(context).inflate(R.layout.related_goal_card, parent, false);
        ...
        public void onBindViewHolder(@NonNull final ImageViewHolder holder, final int position) {
            ...
            holder.menu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    popupMenu.inflate(R.menu.allcard_options);
